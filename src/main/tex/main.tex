...
\begin{document}
    ...
    the HPC, these results were not reproducible.\ Figure~\ref{fig:1} demonstrates the rewards gained by each environment we
    tested while Figure~\ref{fig:2} demonstrates the actor loss.
    ...
    regarding the performance of our hyperparameter manipulations.\ We test the strength of our hyperparameter adjustments using
    ...
    Figures~\ref{fig:3} and~\ref{fig:4} demonstrate this ablation study did not result in better performance than the initial control model.\ We find
