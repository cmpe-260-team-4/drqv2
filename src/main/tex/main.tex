...
\begin{document}
    ...
    \begin{tikzpicture}
    \begin{axis}[
        title = {Hyperparameter Tuning on Walker Run: Reward},
        xlabel = {Episode},
        ylabel = {Reward},
        xmin = 0, xmax = 3200,
        ymin = 0, ymax = 800,
    ...
    \begin{axis}[
        ...
        mark size = .7pt,
        axis line style = ultra thin,
        legend entries = {$Cheetah$, $Walker-Walk$, $Humanoid-Walk$, $Quadruped$,
    ...
    \begin{tikzpicture}
    \begin{axis}[
        title = {Hyperparameter Tuning on Walker Run: Actor Loss},
        xlabel = {Episode},
        ylabel = {Reward},
        xmin = 0, xmax = 3200,
        ymin = -175, ymax = 0,
