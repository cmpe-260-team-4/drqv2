...
\begin{document}
    ...
    \begin{axis}[
        ...
        ymajorgrids = true,
        grid = major,
        legend entries = {$A$, $B$, $C$},] % Hyper parameters for the plots below
    ]
...
%        \legend{CuSO\(_4\cdot\)5H\(_2\)O}
    ...
    \addplot table [x = episode, y = episode_reward, col sep = comma]{walker_run_1520_eval_R.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{walker_run_3090_eval_R.csv};
    ...
    \addplot table [x = episode, y = actor_loss, col sep = comma]{walker_run_3090_train_D.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{walker_run_2090_train_D.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{walker_run_1550_train_D.csv};
    ...
    \addplot table [x = episode, y = actor_loss, col sep = comma]{walker_run_1520_train_R.csv};
