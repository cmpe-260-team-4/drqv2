...
\begin{document}
    ...
    \addplot table [x = episode, y = episode_reward, col sep = comma]{experiments/walker_run_3090_eval_D.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{experiments/walker_run_2090_eval_D.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{experiments/walker_run_1550_eval_D.csv};
    ...
    \begin{axis}[
        ...
        ymajorgrids = true,
        grid = major,
        legend entries = {$Cheetah$, $Human walk$, $Cartpole$, $walker run$, $walker run1$} % Hyper parameters for the plots below
    ]

    \addplot table [x = episode, y = episode_reward, col sep = comma]{others/cheetah_run_3090_eval_R.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{others/humanoid_walk_2420_eval_R.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{others/cartpole_balance_1090_eval_R.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{others/walker_run_1520_eval_R.csv};
    \addplot table [x = episode, y = episode_reward, col sep = comma]{others/walker_run_3090_eval_R.csv};
    ...
    \addplot table [x = episode, y = actor_loss, col sep = comma]{experiments/walker_run_3090_train_D.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{experiments/walker_run_2090_train_D.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{experiments/walker_run_1550_train_D.csv};
    ...
    \begin{axis}[
        ...
        ymajorgrids = true,
        grid = major,
        legend entries = {$Cheetah$, $Human walk$, $Cartpole$, $walker run$, $walker run1$}
    ]

    \addplot table [x = episode, y = actor_loss, col sep = comma]{others/cheetah_run_3090_train_R.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{others/humanoid_walk_2420_train_R.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{others/cartpole_balance_1090_train_R.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{others/walker_run_1520_train_R.csv};
    \addplot table [x = episode, y = actor_loss, col sep = comma]{others/walker_run_3090_train_R.csv};
